...
MISSION_DEFINITIONS = [
    # --- Getting Started ---
    # `track` is the Missions-page pillar tag. Canonical 6-pillar taxonomy:
    # Getting Started, Business Users, Data Engineering, Data Science,
    # App Dev (Lakebase), Governance (see PILLAR_ORDER in Missions.tsx).
    # "All Missions" is a frontend-only meta-filter, not a track value.
    # `category` is kept separately for the mission-tile accent color and is
    # allowed to diverge from `track` (e.g. AI/ML missions keep category
    # "AI / ML" for their tile color while their track is "Data Science").
    {"id": "first_steps", "name": "First Steps", "description": "Record your first Databricks usage", "points": 25, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "rocket", "doc_url": f"{_DOCS}/getting-started/free-edition"},
    ...
    {"id": "gs_data_engineering", "name": "Get Started: Data Engineering", "description": "Complete the free Get Started with Databricks for Data Engineering self-paced course (2 hrs)", "points": 250, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "git-branch", "detection": "training", "doc_url": f"{_ACAD}/2469/get-started-with-databricks-for-data-engineering", "learning_resources": [{"label": "Free self-paced course (2 hrs)", "url": f"{_ACAD}/2469/get-started-with-databricks-for-data-engineering"}]},
    {"id": "gs_machine_learning", "name": "Get Started: Machine Learning", "description": "Complete the free Get Started with Databricks for Machine Learning self-paced course (2 hrs)", "points": 250, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "brain", "detection": "training", "doc_url": f"{_ACAD}/2460/get-started-with-databricks-for-machine-learning", "learning_resources": [{"label": "Free self-paced course (2 hrs)", "url": f"{_ACAD}/2460/get-started-with-databricks-for-machine-learning"}]},
    {"id": "gs_generative_ai", "name": "Get Started: Generative AI", "description": "Complete the free Get Started with Databricks for Generative AI self-paced course (2 hrs)", "points": 250, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "sparkles", "detection": "training", "doc_url": f"{_ACAD}/2724/get-started-with-databricks-for-generative-ai", "learning_resources": [{"label": "Free self-paced course (2 hrs)", "url": f"{_ACAD}/2724/get-started-with-databricks-for-generative-ai"}]},
    {"id": "gs_sql_analytics_bi", "name": "Get Started: SQL Analytics & BI", "description": "Complete the free Get Started with SQL Analytics and BI on Databricks self-paced course (2 hrs)", "points": 250, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "bar-chart-2", "detection": "training", "doc_url": f"{_ACAD}/3347/get-started-with-sql-analytics-and-bi-on-databricks", "learning_resources": [{"label": "Free self-paced course (2 hrs)", "url": f"{_ACAD}/3347/get-started-with-sql-analytics-and-bi-on-databricks"}]},
    {"id": "gs_data_warehousing", "name": "Get Started: Data Warehousing", "description": "Complete the free Get Started with Databricks for Data Warehousing self-paced course (2 hrs)", "points": 250, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "database", "detection": "training", "doc_url": f"{_ACAD}/3603/get-started-with-databricks-for-data-warehousing", "learning_resources": [{"label": "Free self-paced course (2 hrs)", "url": f"{_ACAD}/3603/get-started-with-databricks-for-data-warehousing"}]},
    {"id": "gs_platform_admin", "name": "Get Started: Platform Administration", "description": "Complete the free Get Started with Databricks Platform Administration self-paced course (2 hrs)", "points": 250, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "cpu", "detection": "training", "doc_url": f"{_ACAD}/2453/get-started-with-databricks-platform-administration", "learning_resources": [{"label": "Free self-paced course (2 hrs)", "url": f"{_ACAD}/2453/get-started-with-databricks-platform-administration"}]},
    {"id": "gs_data_governance", "name": "Get Started: Data Governance", "description": "Complete the free Get Started with Data Governance on Databricks self-paced course (2 hrs)", "points": 250, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "share", "detection": "training", "doc_url": f"{_ACAD}/4677/get-started-with-data-governance-on-databricks", "learning_resources": [{"label": "Free self-paced course (2 hrs)", "url": f"{_ACAD}/4677/get-started-with-data-governance-on-databricks"}]},
    {"id": "gs_lakebase", "name": "Get Started: Lakebase", "description": "Complete the free Get Started with Lakebase self-paced course (2 hrs)", "points": 250, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "database", "detection": "training", "doc_url": f"{_ACAD}/5081/get-started-with-lakebase", "learning_resources": [{"label": "Free self-paced course (2 hrs)", "url": f"{_ACAD}/5081/get-started-with-lakebase"}]},
    {"id": "gs_lakehouse_architecture", "name": "Get Started: Lakehouse Architecture", "description": "Complete the free Get Started with Lakehouse Architecture on Databricks self-paced course (2 hrs)", "points": 250, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "layers", "detection": "training", "doc_url": f"{_ACAD}/3509/get-started-with-lakehouse-architecture-on-databricks", "learning_resources": [{"label": "Free self-paced course (2 hrs)", "url": f"{_ACAD}/3509/get-started-with-lakehouse-architecture-on-databricks"}]},
    # AI Agents has no FREE self-paced edition in the catalog; its instructor-led course is free (price 0), so link that.
    {"id": "gs_ai_agents", "name": "Get Started: AI Agents", "description": "Complete the free Get Started with AI Agents on Databricks course (2 hrs)", "points": 250, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "zap", "detection": "training", "doc_url": f"{_ACAD}/4459/get-started-with-ai-agents-on-databricks", "learning_resources": [{"label": "Free course (2 hrs)", "url": f"{_ACAD}/4459/get-started-with-ai-agents-on-databricks"}]},
    {"id": "databricks_learner", "name": "Databricks Learner", "description": "Complete 2 or more Get Started courses to be recognized as a Databricks learner", "points": 500, "category": "Getting Started", "track": "Getting Started", "award_type": "one_time", "icon": "award", "detection": "training", "doc_url": "https://www.databricks.com/learn/training/home"},
    # --- Data Engineering ---
    {"id": "job_creator", "name": "Job Creator", "description": "Create your first Lakeflow Job", "points": 100, "category": "Data Engineering", "track": "Data Engineering", "award_type": "one_time", "icon": "briefcase", "doc_url": f"{_DOCS}/jobs/create-run-jobs"},
    {"id": "pipeline_builder", "name": "Pipeline Builder", "description": "Create your first Lakeflow Spark Declarative Pipeline", "points": 150, "category": "Data Engineering", "track": "Data Engineering", "award_type": "one_time", "icon": "git-branch", "doc_url": f"{_DOCS}/ldp/"},
    {"id": "pipeline_runner", "name": "Pipeline Runner", "description": "Complete your first successful pipeline update", "points": 200, "category": "Data Engineering", "track": "Data Engineering", "award_type": "one_time", "icon": "play-circle", "doc_url": f"{_DOCS}/ldp/tutorial-pipelines"},
    {"id": "scheduler", "name": "Scheduler", "description": "Create a scheduled or CRON-triggered job", "points": 150, "category": "Data Engineering", "track": "Data Engineering", "award_type": "one_time", "icon": "clock", "doc_url": f"{_DOCS}/jobs/triggers"},
    {"id": "auto_loader_pioneer", "name": "Auto Loader Pioneer", "description": "Use Auto Loader in a pipeline for streaming ingestion", "points": 250, "category": "Data Engineering", "track": "Data Engineering", "award_type": "one_time", "icon": "upload-cloud", "doc_url": f"{_DOCS}/ingestion/cloud-object-storage/auto-loader/"},
    {"id": "multi_task_orchestrator", "name": "Multi-Task Orchestrator", "description": "Create a workflow with 3+ tasks", "points": 200, "category": "Data Engineering", "track": "Data Engineering", "award_type": "one_time", "icon": "git-branch", "doc_url": f"{_DOCS}/jobs/configure-task"},
    {"id": "liquid_clustering", "name": "Liquid Clustering Adopter", "description": "Enable Liquid Clustering on a table", "points": 200, "category": "Data Engineering", "track": "Data Engineering", "award_type": "one_time", "icon": "layers", "doc_url": f"{_DOCS}/delta/clustering/"},
    ...
    {"id": "lakebase_builder", "name": "Lakebase Builder", "description": "Create your first Lakebase (Postgres) database instance", "points": 250, "category": "Lakebase", "track": "App Dev (Lakebase)", "award_type": "one_time", "icon": "database", "doc_url": f"{_DOCS}/oltp/create/"},
    {"id": "lakebase_sync", "name": "Lakebase Sync Builder", "description": "Sync a Unity Catalog table into Lakebase", "points": 250, "category": "Lakebase", "track": "App Dev (Lakebase)", "award_type": "one_time", "icon": "upload-cloud", "doc_url": f"{_DOCS}/oltp/"},
    {"id": "lakebase_database", "name": "Lakebase Database Creator", "description": "Create a Lakebase database or registered catalog", "points": 150, "category": "Lakebase", "track": "App Dev (Lakebase)", "award_type": "one_time", "icon": "database", "doc_url": f"{_DOCS}/oltp/create/"},
    {"id": "lakebase_connector", "name": "Lakebase Connector", "description": "Connect to Lakebase from an app or client", "points": 100, "category": "Lakebase", "track": "App Dev (Lakebase)", "award_type": "one_time", "icon": "zap", "doc_url": f"{_DOCS}/oltp/query/"},
    {"id": "lakebase_branch_master", "name": "Lakebase Branch Master", "description": "Create a branch in a Lakebase Postgres project", "points": 200, "category": "Lakebase", "track": "App Dev (Lakebase)", "award_type": "one_time", "icon": "git-branch", "doc_url": f"{_DOCS}/oltp/projects/branches"},
    {"id": "lakebase_role_architect", "name": "Lakebase Role Architect", "description": "Create a custom PostgreSQL role in Lakebase", "points": 150, "category": "Lakebase", "track": "App Dev (Lakebase)", "award_type": "one_time", "icon": "shield", "doc_url": f"{_DOCS}/oltp/projects/postgres-roles"},
    {"id": "lakebase_cdf_pioneer", "name": "Lakebase Reverse ETL Pioneer", "description": "Stream Lakebase changes back into Unity Catalog with Change Data Feed", "points": 250, "category": "Lakebase", "track": "App Dev (Lakebase)", "award_type": "one_time", "icon": "upload-cloud", "doc_url": f"{_DOCS}/oltp/projects/lakebase-cdf"},
    # --- AI / ML ---
    {"id": "model_deployer", "name": "Model Deployer", "description": "Deploy a model to a serving endpoint", "points": 300, "category": "AI / ML", "track": "Data Science", "award_type": "one_time", "icon": "cpu", "doc_url": f"{_DOCS}/machine-learning/model-serving/"},
    {"id": "ai_function_builder", "name": "AI Function Builder", "description": "Use ai_query() in a SQL statement", "points": 250, "category": "AI / ML", "track": "Data Science", "award_type": "one_time", "icon": "sparkles", "doc_url": f"{_DOCS}/large-language-models/ai-query/"},
    {"id": "vector_search_pioneer", "name": "Vector Search Pioneer", "description": "Create a Vector Search index", "points": 200, "category": "AI / ML", "track": "Data Science", "award_type": "one_time", "icon": "search", "doc_url": f"{_DOCS}/generative-ai/vector-search/"},
    ...
    {"id": "ml_practitioner", "name": "ML Practitioner", "description": "Consume any Model Serving DBUs in a month", "points": 150, "category": "AI / ML", "track": "Data Science", "award_type": "repeatable", "icon": "brain", "doc_url": f"{_DOCS}/machine-learning/model-serving/"},
    # --- Engagement ---
    {"id": "consistent_operator", "name": "Consistent Operator", "description": "Run pipelines or jobs on 7 distinct days within 30 days", "points": 300, "category": "Engagement", "track": "Governance", "award_type": "repeatable", "icon": "calendar-check", "doc_url": f"{_DOCS}/admin/system-tables/"},
    {"id": "daily_driver", "name": "Daily Driver", "description": "Active on 20+ days in a 30-day window", "points": 400, "category": "Engagement", "track": "Getting Started", "award_type": "repeatable", "icon": "calendar", "doc_url": f"{_DOCS}/admin/system-tables/"},
    {"id": "cross_product_champion", "name": "Cross-Product Champion", "description": "Use 6+ distinct Databricks products in a month", "points": 500, "category": "Engagement", "track": "Getting Started", "award_type": "repeatable", "icon": "award", "doc_url": f"{_DOCS}/admin/system-tables/billing"},
    # --- Governance ---
    {"id": "uc_publisher", "name": "Unity Catalog Publisher", "description": "Share a table across schemas", "points": 150, "category": "Governance", "track": "Governance", "award_type": "one_time", "icon": "share", "doc_url": f"{_DOCS}/data-governance/unity-catalog/"},
    {"id": "catalog_architect", "name": "Catalog Architect", "description": "Create a Unity Catalog catalog", "points": 150, "category": "Governance", "track": "Governance", "award_type": "one_time", "icon": "database", "doc_url": f"{_DOCS}/catalogs/create-catalog"},
    {"id": "external_location_pioneer", "name": "External Location Pioneer", "description": "Configure secure access to cloud storage with an external location", "points": 200, "category": "Governance", "track": "Governance", "award_type": "one_time", "icon": "shield", "doc_url": f"{_DOCS}/connect/unity-catalog/cloud-storage/s3/s3-external-location-manual"},
    {"id": "lakehouse_federation_pioneer", "name": "Lakehouse Federation Pioneer", "description": "Connect an external database system with Lakehouse Federation", "points": 250, "category": "Governance", "track": "Governance", "award_type": "one_time", "icon": "globe", "doc_url": f"{_DOCS}/query-federation/"},
    {"id": "data_sharer", "name": "Data Sharer", "description": "Share data with another organization using Delta Sharing", "points": 200, "category": "Governance", "track": "Governance", "award_type": "one_time", "icon": "share-2", "doc_url": f"{_DOCS}/opensharing/share-data-open"},
]
